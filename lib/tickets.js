...
export const generatePDFTicket = async (registration, event, batch, qrCode) => {
  ...
  pdf.text(`Batch: ${batch?.name || "General"}`, margin + 15, 91);

  /* DIVIDER */
  pdf.setDrawColor(220, 220, 220);
  pdf.line(margin + 5, 100, W - margin - 5, 100);

  /* ATTENDEE DETAILS */
  pdf.setFont("helvetica", "bold");
  pdf.setFontSize(14);
  pdf.text("ATTENDEE DETAILS", margin + 15, 115);
